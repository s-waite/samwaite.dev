...
export default function Project() {
    return (
        <div className='sm:overflow-auto sm:w-screen'>
            <div className={`border-b-2 border-dotted h-20 pl-4 ${poppins.className} text-3xl fixed w-full top-0 pt-6 bg-white`}>Projects</div>
            {/* <div className='h-20 fixed top-[79px] w-full from-white to-transparent bg-gradient-to-b z-50'></div> */}
            <div className='mx-4 mt-20 flex flex-wrap gap-6 sm:m-0'>
                <Card
                    imagePath={testPic}
                    imageAlt='alt'
